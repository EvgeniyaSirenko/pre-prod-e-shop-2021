...
public class CreateProductWithAnnotationAndReflectionCommand implements Command {
	...
	public CreateProductWithAnnotationAndReflectionCommand(ProductService productService, FactoryContainer factoryContainer) {
	...
	public void execute() {
		...
		try {
			...
			productService.createNewProductUsingReflection(inputCategory);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
